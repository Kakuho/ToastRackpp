...
//      five equal bytes by a four-byte code ED ED xx yy, which stands for 
...
//
//      Finally, every byte directly following a single ED is not taken into a 
//      block, for example ED 6*00 is not encoded into ED ED ED 06 00 but 
//      into ED 00 ED ED 05 00. 
//
//      The block is terminated by an end marker, 00 ED ED 00.
//      [https://worldofspectrum.org/faq/reference/z80format.htm]
//
//  * Version 2 and Version 3 follows the same compression scheme, however the 
//    structure of a compressed block is slightly different:
//        
